...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'subject_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\db\Subject::find()->andWhere(['status'=>1])->orderBy('name')->asArray()->all(), 'id', 'name'),
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowUserSubject(' . $key . '); return false;', 'id' => 'user-subject-del-btn','class' => 'remove']);
            },
        ],
    ],
    'gridSettings' => [
