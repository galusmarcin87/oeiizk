...
/* @var $searchModel app\models\mgcms\db\LogSearch */
...
<div class="log-index">
  ...
  $gridColumn = [
      ...
      [
          ...
          'filterInputOptions' => ['placeholder' => Yii::t('app', 'Created By'), 'id' => 'grid-log-search-created_by']
      ],
      [
          'attribute' => 'created_on',
          'filterInputOptions' => [
              'class' => 'form-control',
              'title' => 'Aby filtrować w zakresie dat oddziel 2 daty ":" np "2018-11-06:2018-11-09"'
          ]
      ],
      'type',
      'htmlText:raw',
