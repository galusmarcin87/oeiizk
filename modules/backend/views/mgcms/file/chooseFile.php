...
<div class="file-index">
  <p>
    <? $controller = Yii::$app->controller->id;
            if(\app\components\mgcms\MgHelpers::getUserModel()->checkAccess(str_replace(['mgcms/','oeizk/'], '', $controller), 'create')):?><?= Html::a(Yii::t('app', 'Create File'), ['create', 'emptyLayout' => true], ['class' => 'btn btn-success']) ?>
    <?endif?>
  </p>
  <?php
  $gridColumn = [
