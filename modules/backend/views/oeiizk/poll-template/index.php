...
/* @var $searchModel app\models\db\PollTemplateSearch */
...
$this->title = Yii::t('app', 'Poll Templates');
...
<div class="poll-template-index">
  ...
  <p>
    ...
    if (\app\components\mgcms\MgHelpers::getUserModel()->checkAccess($controller, 'create')):
      ...
      ?>
      <?= Html::a(Yii::t('app', 'Create Poll Template'), ['create'], ['class' => 'btn btn-success']) ?>
    <? endif ?>
  </p>
  <?php
  $gridColumn = [
...
//      ],
      ...
      [
          'attribute' => 'type',
          'filter' => MgHelpers::dropdownDataFromSettings('Typy szablon ankiet'),
      ],
      [
