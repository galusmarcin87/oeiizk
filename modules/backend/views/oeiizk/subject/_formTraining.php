...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'training_template_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\db\TrainingTemplate::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'lab_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\db\Lab::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
