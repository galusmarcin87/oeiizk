...
echo TabularForm::widget([
    ...
    'attributes' => [
        'educational_level_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(app\models\db\EducationalLevel::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
    ...
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add User Educational Level'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowUserEducationalLevel()']),
        ]
    ]
]);
echo  "    </div>\n\n";
