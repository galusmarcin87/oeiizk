...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'poll_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\mgcms\db\Poll::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
        ...
        'article_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\mgcms\db\Article::find()->orderBy('title')->asArray()->all(), 'id', 'title'),
        ...
        'subject_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\mgcms\db\Subject::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
