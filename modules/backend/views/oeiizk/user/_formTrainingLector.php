...
echo TabularForm::widget([
    ...
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Training Lector'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowTrainingLector()']),
        ]
    ]
]);
echo  "    </div>\n\n";
