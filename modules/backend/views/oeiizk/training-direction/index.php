...
/* @var $searchModel app\models\db\TrainingDirectionSearch */
...
$this->title = Yii::t('app', 'Training Directions');
...
<div class="training-direction-index">
    ...
    <p>
      <? $controller = Yii::$app->controller->id;
        ...
        <?= Html::a(Yii::t('app', 'Create Training Direction'), ['create'], ['class' => 'btn btn-success']) ?>
        <? endif?>
    </p>
    <?php 
    $gridColumn = [
