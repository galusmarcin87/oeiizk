  ...
  echo TabularForm::widget([
      ...
      'attributes' => [
          ...
          'training_direction_id' => [
              ...
              'options' => [
                  'data' => \yii\helpers\ArrayHelper::map(\app\models\db\TrainingDirection::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
                  'options' => ['placeholder' => Yii::t('app', 'Choose Training direction')],
              ],
      ...
      'gridSettings' => [
          'panel' => [
              ...
              'before' => false,
              'footer' => false,
              'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Dodaj kierunek'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowTrainingTrainingDirection()']),
          ]
      ]
  ]);
  echo "    </div>\n\n";
