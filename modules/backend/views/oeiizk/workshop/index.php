...
/* @var $searchModel app\models\db\WorkshopSearch */
...
<div class="workshop-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => Yii::t('app', 'Lab'), 'id' => 'grid-workshop-search-lab_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => Yii::t('app', 'Training'), 'id' => 'grid-workshop-search-training_id']
            ],
        'order',
