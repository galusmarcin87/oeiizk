...
use Yii;
use app\models\db\SmsTemplate;
use app\models\db\SmsTemplateSearch;
 ...
 */
class SmsTemplateController extends MgBackendController
{
    ...
    /**
     * 
     * Export SmsTemplate information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new SmsTemplate model by another data,
