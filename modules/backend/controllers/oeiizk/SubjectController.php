...
use app\models\db\SubjectSearch;
 ...
 */
class SubjectController extends MgBackendController
{
    ...
    /**
     * 
     * Export Subject information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Subject model by another data,
