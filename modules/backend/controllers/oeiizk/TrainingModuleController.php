...
use app\models\db\TrainingModuleSearch;
 ...
 */
class TrainingModuleController extends MgBackendController
{
    ...
    /**
     * 
     * Export TrainingModule information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new TrainingModule model by another data,
