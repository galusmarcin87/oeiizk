...
use app\models\db\TrainingDirectionSearch;
 ...
 */
class TrainingDirectionController extends MgBackendController
{
    ...
    /**
     * 
     * Export TrainingDirection information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new TrainingDirection model by another data,
