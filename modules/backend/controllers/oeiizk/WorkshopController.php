...
use app\models\db\WorkshopSearch;
 ...
 */
class WorkshopController extends MgBackendController
{
    ...
    /**
     * 
     * Export Workshop information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Workshop model by another data,
    ...
    */
    ...
    {
        $searchModel = new \app\models\db\WorkshopUser();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
