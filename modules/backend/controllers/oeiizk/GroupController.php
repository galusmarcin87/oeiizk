 ...
 */
class GroupController extends MgBackendController
{
  public $importClass = 'app\models\db\UserGroup';
    ...
    public function actionView($id)
    {
        ...
        $providerNewsletter = new \yii\data\ArrayDataProvider([
        ...
        return $this->render('view', [
            'model' => $this->findModel($id),
            'providerNewsletter' => $providerNewsletter,
    ...
    */
    public function actionAddNewsletter()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Newsletter');
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formNewsletter', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
